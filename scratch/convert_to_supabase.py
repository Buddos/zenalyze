#!/usr/bin/env python3
"""
Convert MySQL dump from user prompt into clean, PostgreSQL / Supabase compatible SQL script.
"""
...
with open('/home/bonface/Documents/zenalyze/supabase_schema_and_data.sql', 'w') as f:
    f.write(sql_content)

print("Successfully generated /home/bonface/Documents/zenalyze/supabase_schema_and_data.sql")
