...
urlpatterns = [
    ...
    path('exercises/session/start/<int:exercise_id>/', views.start_exercise_session_api, name='start_exercise_session'),
    path('exercises/session/<int:session_id>/progress/', views.update_exercise_session_api, name='update_exercise_session'),
