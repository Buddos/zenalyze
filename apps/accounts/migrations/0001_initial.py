    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('admin', 'Admin'), ('therapist', 'Therapist'), ('moderator', 'Moderator')], default='user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weekly_summary_day', models.CharField(default='sunday', max_length=20)),
                ('data_sharing_level', models.CharField(default='anonymous', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
